...
const DetailMember = () => {
  ...
  return (
    <Layout>
      ...
      <div className="mb-20 mt-14 w-full bg-color1 px-8 text-color5 md:mb-96 md:px-20 lg:mb-8 lg:px-20">
        <p className="TitleShadow text-[28px] font-semibold md:text-[30px] lg:text-[32px]">Detail Peserta {data.name}</p>
        ...
        <div className="mt-5 flex w-full flex-col justify-start gap-10 md:mt-14 md:flex-row md:gap-16 lg:mt-16 lg:flex-row lg:gap-20">
          ...
          <div className="text-center md:w-6/12 lg:w-5/12">
            <p className="text-[16px] font-semibold">bukti pembayran pendaftaran :</p>
            <div className="flex flex-col items-center gap-5 md:flex-col lg:flex-row">
              <img src={"https://be.sabilunnashr.com/storage/" + data.upload_file} alt="Bukti Transfer" className="m-auto mt-2 h-52 w-full rounded-xl border-2 border-zinc-500 bg-contain bg-center bg-no-repeat object-contain" />
            </div>

            <p className="mt-5 text-[16px] font-semibold">Alasan Singkat Mendaftar :</p>
            <div className="mt-2 h-36 w-full overflow-auto rounded-md border-2 border-zinc-500 text-left">
