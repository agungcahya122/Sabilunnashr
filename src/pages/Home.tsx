    ...
    <Layout>
      ...
      <div id="Home" className="flex flex-row bg-color4 pb-10 md:pb-16 lg:pb-20">
        <div className="float-left hidden md:relative md:block md:w-4/12 lg:relative lg:block lg:w-4/12">
          <img src={Masjid} alt="masjid.svg" className=" top-20 left-0 float-left w-full md:absolute md:left-0 md:top-0 md:w-10/12 lg:absolute lg:left-0 lg:top-0 lg:w-9/12" />
        </div>
        ...
        <div className="w-full pr-5 pl-8 pt-8 text-[15px] text-color1 md:w-8/12 md:px-8 md:pl-0 md:pt-12 md:text-[16px] lg:w-8/12 lg:px-16 lg:pl-0 lg:pt-16 lg:text-[18px]">
          ...
          <div className="mt-10 flex flex-col gap-4 pl-0 pr-24 text-[15px] md:flex-row md:gap-8 md:pl-0 md:pr-0 md:text-[14px] lg:flex-row lg:gap-8 lg:pl-4 lg:pr-4 lg:text-[16px]">
            ...
            <div className="flex gap-2 rounded-full bg-color6 px-6 py-2 shadow-[1px_2px_4px_0px_rgba(0,0,0,0.5)]">
              <img src={Instagram} alt="logo.svg" className="w-5 md:w-6 lg:w-6" />
      ...
      <div id="Adab" className="flex flex-col-reverse bg-color1 text-[15px] md:flex-row md:text-[14px] lg:flex-row lg:text-[16px]">
        ...
        <div className="w-full pt-5 pb-5 text-center text-color5 md:w-4/12 md:pt-10 md:pl-8 lg:w-4/12 lg:pt-10 lg:pl-20">
          ...
          <img src={Adab} alt="adab.svg" className="ml-28 mt-5 h-64 md:ml-4 md:h-80 lg:ml-4 lg:h-80" />
        </div>
      </div>

      <div id="Dzikir" className="flex flex-col bg-color4 pt-2 pb-10 text-[15px] text-color1 md:flex-row md:pt-10 md:text-[14px] lg:flex-row lg:pt-10 lg:text-[16px]">
      ...
      <div id="Wudlu" className="flex flex-col-reverse bg-color1 pt-5 pb-10 text-[15px] text-color5 md:flex-row md:pt-10 md:text-[14px] lg:flex-row lg:pt-10 lg:text-[16px]"
      >
      ...
      <div id="Jarfisya" className="relative w-full bg-color4 text-color1 md:pb-8 lg:pb-8 lg:text-[16px]">
        ...
        <div className="mt-16 flex flex-row justify-center gap-10">
          <div className="flex w-4/12 flex-col gap-8 pr-2 ">
            <div className="flex items-center gap-4">
              ...
              <input onChange={nameChange} id="name" type="text" placeholder="Tuliskan nama anda" className="input-border input h-8 w-full max-w-full rounded-lg border-2 border-zinc-500 bg-color1 px-4 py-4 text-[16px] text-color5 placeholder-slate-400" />
            </div>

            <div className="flex items-center gap-4">
              <p className="w-5/12 text-[16px] font-semibold">Email :</p>
              <input onChange={emailChange} id="email" type="text" placeholder="Tuliskan email anda" className="input-border input h-8 w-full max-w-full rounded-lg border-2 border-zinc-500 bg-color1 px-4 py-4 text-[16px] text-color5 placeholder-slate-400" />
            </div>

            <div className="flex items-center gap-4">
              <p className="w-5/12 text-[16px] font-semibold">Whatsapp :</p>
              <input onChange={waChange} id="wa" type="number" placeholder="Tuliskan nomor whatsapp anda" className="input-border input h-8 w-full max-w-full rounded-lg border-2 border-zinc-500 bg-color1 px-4 py-4 text-[16px] text-color5 placeholder-slate-400" />
            </div>

            <div className="flex items-center gap-4">
              <p className="w-5/12 text-[16px] font-semibold">Domisili :</p>
              <input onChange={domicileChange} id="domicile" type="text" placeholder="Tempat tinggal anda sekarang" className="input-border input h-8 w-full max-w-full rounded-lg border-2 border-zinc-500 bg-color1 px-4 py-4 text-[16px] text-color5 placeholder-slate-400" />
            </div>

            <div className="flex items-center gap-4">
              <p className="w-5/12 text-[16px] font-semibold">Pekerjaan :</p>
              <input onChange={jobChange} id="job" type="text" placeholder="Tuliskan pekerjaan anda" className="input-border input h-8 w-full max-w-full rounded-lg border-2 border-zinc-500 bg-color1 px-4 py-4 text-[16px] text-color5 placeholder-slate-400" />
            </div>

            <div className="flex items-center gap-4">
              <p className="w-5/12 text-[16px] font-semibold">Usia :</p>
              <input onChange={ageChange} id="age" type="number" placeholder="Tuliskan pekerjaan anda" className="input-border input h-8 w-full max-w-full rounded-lg border-2 border-zinc-500 bg-color1 px-4 py-4 text-[16px] text-color5 placeholder-slate-400" />
            </div>

            <div className="flex items-center gap-4">
              <p className="w-5/12 text-[16px] font-semibold">Gender :</p>
              <select onChange={genderChange} name="option" id="gender" className="select-ghost select w-[19rem] max-w-full rounded-lg border-2 border-zinc-500 text-color5" >
          ...
          <div className="w-5/12 pl-8">
            ...
            <div className="flex items-center gap-5">
              <img src={imgSrc} alt="rekening.jpg" className="mt-5 h-40 w-48 rounded-xl border-2 border-zinc-500 bg-contain bg-center bg-no-repeat" />
              <div className="mt-auto">
                <input onChange={fileChange} id="upload_file" type="file" className="block w-full text-[16px] text-slate-500 file:mr-4 file:rounded-xl file:border-2 file:border-zinc-200 file:bg-color4 file:py-2 file:px-6 file:text-[16px] file:font-semibold file:text-color1 hover:file:bg-[rgba(13,206,218,0.8)]" />
            ...
            <textarea onChange={reasonChange} id="reason" typeof="text" placeholder="Tuliskan alasan singkat kenapa anda tertarik" className="input-border input mt-2 h-20 w-9/12 max-w-full rounded-lg border-2 border-zinc-500 bg-color1 px-2 py-2 text-[16px] text-color5 placeholder-slate-400" />
          </div>
        </div>

        <CustomButton id="submit" onClick={ramadhanPost} label="Mengirim Formulir Untuk Mendaftar" className="mb-16 mt-16 ml-[34vw] rounded-2xl bg-color6 py-2 px-6 text-[18px] font-semibold text-white hover:bg-[rgb(0,140,255)] disabled:cursor-not-allowed disabled:bg-color2" />
      </div>
