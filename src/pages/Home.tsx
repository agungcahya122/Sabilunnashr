    ...
    <Layout>
      ...
      <div id="Home" className="flex flex-row bg-color4 pb-10 md:pb-16 lg:pb-20">
        ...
        <div className="w-full pr-5 pl-8 pt-8 text-[15px] text-color1 md:w-8/12 md:px-8 md:pl-0 md:pt-12 md:text-[16px] lg:w-8/12 lg:px-16 lg:pl-0 lg:pt-16 lg:text-[18px]">
          ...
          <p className="mt-8 ">
            Saat ini dibukan pendaftaran kelas online
            <span className="font-semibold italic"> Fikih, akidah-akhlak, dan gabungan keduanya </span>
            Pendaftaran dimulai dari
            <span className="font-semibold text-color5"> Jumat, 31 Maret 2023 - 31 Mei 2023 </span>
          </p>
      ...
      <div id="Adab" className="flex flex-col-reverse bg-color1 text-[15px] md:flex-row md:text-[14px] lg:flex-row lg:text-[16px]">
        <div className="w-full pt-2 pb-8 pl-5 pr-5 text-justify text-color5 md:w-8/12 md:pt-14 md:pr-0 md:pl-16 lg:w-8/12 lg:pr-0 lg:pt-14 lg:pl-64">
          ...
          <p className="mt-8">
            ...
            <span className="font-semibold italic">“Azza wa Jalla”</span> atau <span className="font-semibold italic">“Ta'ala”, “Subhanahu wa Ta'ala”, “Tabaraka wa Ta'ala”, “Jalla Dzikruhu”, “Tabarakasmuhu”,</span> atau{" "}
            <span className="font-semibold italic">“Jallat 'Azhamtuhu”,</span> atau yang semacamnya.
          </p>
        ...
        <div className="w-full pt-5 pb-5 text-center text-color5 md:w-4/12 md:pt-10 md:pl-8 lg:w-4/12 lg:pt-10 lg:pl-20">
          ...
          <p className="mt-4 pr-4 pl-4 text-[16px] font-bold md:pl-0 md:pr-8 md:text-[14px] lg:pl-0 lg:pr-10 lg:text-[16px]">Ketika menyebut nama Allah ta'ala dan Rasulullah SAW</p>
          <img src={Adab} alt="adab.svg" className="mt-5 ml-24 h-64 md:ml-4 md:h-64 lg:ml-4 lg:h-80" />
        </div>
      </div>
      ...
      <div id="Dzikir" className="flex flex-col bg-color4 pt-2 pb-10 text-[15px] text-color1 md:flex-row md:pt-10 md:text-[14px] lg:flex-row lg:pt-10 lg:text-[16px]">
        ...
        <div className="w-full pl-8 pt-5 pr-5 text-justify md:w-7/12 md:pt-2 md:pr-8 lg:w-7/12 lg:pt-2 lg:pr-14">
          ...
          <p className="mt-5">
            Sunnah dzikir setelah selesai shalat fardlu menurut pendapat mu'tamad/resmi <span className="font-semibold">Madzhab Syafi'i</span> adalah dzikir setelah shalat fardlu itu <span className="font-semibold">dipelankan (sirr)</span>.
            Kecuali bagi imam yang berkehendak mengajari para makmum untuk berdzikir, maka imam bisa mengeraskan (jahr) bacaan dzikirnya.
          </p>
          ...
          <p className="mt-5 mb-5 pl-0 text-[20px] font-semibold md:text-[16px] lg:pl-28 lg:text-[20px]">وَينْدب الذّكر عقب الصَّلَاة وَيسر بِهِ إِلَّا الإِمَام المريد تَعْلِيم الْحَاضِرين فيجهر إِلَى أَن يتعلموا</p>
          <p>
            Artinya :
            <br />
        ...
        <div className="mt-5 flex flex-col pl-12 text-justify text-[15px]  text-color1 md:flex-col md:pl-14 md:text-[16px] lg:flex-row lg:pl-20 lg:text-[16px]">
          <div className="flex w-11/12 flex-col md:w-11/12 lg:w-6/12 ">
            <ul className="mr-0 w-11/12 list-outside list-decimal leading-loose md:mr-16 md:w-11/12 md:leading-relaxed lg:w-11/12 lg:leading-relaxed">
              <p className="-ml-4 text-xl font-extrabold">Rincian kelas</p>
            ...
            <ul className="mr-0 w-11/12 list-outside list-disc leading-loose md:mr-0 md:mt-10 md:w-6/12 md:leading-relaxed lg:mr-16 lg:mt-10 lg:w-6/12 lg:leading-relaxed">
              <p className="-ml-4 text-xl  font-extrabold">Fasilitas Lengkap</p>
          ...
          <div className="mt-8 w-full pl-14 md:mt-8 md:w-full md:pl-64 lg:mt-0 lg:w-6/12 lg:pl-24">
            <div className="mt-5 ml-16 flex rounded-tl-2xl rounded-bl-2xl bg-color6 px-5 py-2 text-[24px] font-semibold shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] md:px-8 lg:px-8">
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="flex gap-3 border-l-2 border-color1 pt-1 pl-2 text-[10px] md:pl-4 md:text-[13px] lg:pl-4 lg:text-[13px]">
            ...
            <div className="mt-5 ml-8 flex rounded-tl-2xl rounded-bl-2xl bg-color6 px-5 py-2 text-[24px] font-semibold shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] md:px-8 lg:px-8">
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="flex border-l-2 border-color1 pt-1 pl-2 text-[10px] md:pl-4 md:text-[13px] lg:pl-4 lg:text-[13px]">
          ...
          <div className="md:w-6/12 lg:w-5/12">
            <div className="mb-5 flex items-center gap-1">
              ...
              <select onChange={handleChangeInput} name="paket" id="gender" className="select-ghost select max-w-full rounded-lg border-2 border-zinc-500 text-color5">
                ...
                <option value="2">2 (BERAKAL Akidah Akhlak)</option>
